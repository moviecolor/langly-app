...
|------|---------|-------|--------------|-------|---------------|
| 2026-09-25 | 1.2 | 4 | `4b530a1d-abb6-4b0b-97e3-5783cb494538` | **External beta LIVE** — group "Langly Beta Testers" created; Juliana Longo + Rafa Grip invited (Apple emails sent, Beta Review pre-approved). Langly Premium subscription `6815736929` READY_TO_SUBMIT; GitHub push auth fixed (playbook §10); Juliana WhatsApp letter (docs/). | `fix/l1.2-phone-bugs` |
